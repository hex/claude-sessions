...
### Changed
- The effort word after the model name takes Claude Code's own `/effort` colours: low gold, medium green, high blue, xhigh violet, and max painted as a blue-to-pink gradient across its three letters. Lifted toward white on a dark terminal.
