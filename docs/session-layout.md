...
| `wrapped` | The conversation a `/wrap` finished in, written by its last pass; the cs-rotate band hides the wrap key while it names the conversation, and the next prompt empties it. |
