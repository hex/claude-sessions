...
# prompt stops the countdown. Not a number, or unset: never forced. Keep it
# above a fresh conversation's own footprint: a threshold the wake turn
# already sits past rotates again at once.
