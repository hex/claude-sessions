...
_cs_completions() {
    ...
    # Global flags
    local global_flags="-list -ls -adopt -remove -rm -whoami -who -secrets -checkpoint -queue -msg -spawn -conversations -search -lint -statusline -detect-theme -doctor -diag -update -uninstall -help -h -version -v -live -usage -status -tag -archive -unarchive"
    ...
    local session_opts="-secrets -queue -msg -conversations -usage -tag -features -finish --force --merge"
