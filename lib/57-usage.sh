...
# rate-limit stamp when one exists. Sets globals: U_NOW, U_W5_ISO, U_WK_ISO
# (globals, not stdout — callers need several values and the limits read
# already sets U_* the same way).
